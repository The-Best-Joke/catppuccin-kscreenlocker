...
LockScreenLocal.SessionManagementScreen {
    id: sessionManager

    readonly property color catSubtext0: LockScreenLocal.CatPalette.subtext0
    ...
    ColumnLayout {
        ...
        LockScreenLocal.CatPasswordField {
            id: passwordBox
            ...
            controlHeight: 36
            dotSpacing: 4
            failed: root.notification.length > 0
        ...
        LockScreenLocal.CatPrimaryButton {
            id: loginButton
            text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@action:button", "Unlock")
            ...
            controlWidth: 260
            controlHeight: 36
            enabled: passwordBox.text.length > 0 && !authenticator.graceLocked
    ...
    component FailableLabel : PlasmaComponents3.Label {
        ...
        text: label
        color: sessionManager.catSubtext0
    ...
    FailableLabel {
        ...
        label: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:usagetip", "Scan your fingerprint")
    }
    FailableLabel {
        kind: ScreenLocker.Authenticator.Smartcard
        label: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:usagetip", "Scan your smartcard")
    }
}
