...
Item {
    ...
    readonly property color catBase: LockScreenLocal.CatPalette.base
    ...
    MouseArea {
        ...
        Timer {
            ...
            running: true
            repeat: true
            onTriggered: lockScreenUi.currentTime = new Date()
        }
        ...
        WallpaperFader {
            ...
            footer: footer
            clock: clock
            alwaysShowClock: lockScreenUi.nativeAlwaysShowClock && !lockScreenUi.nativeHideClockWhenIdle
        }
        ...
        PlasmaComponents3.Label {
            ...
            z: 1
            visible: LockScreenLocal.ThemeConfig.showLayoutLabel && keyboardLayoutSwitcher.hasMultipleKeyboardLayouts
            text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:label", "Layout: %1", keyboardLayoutSwitcher.layoutNames.longName)
            color: lockScreenUi.catText
            font.family: LockScreenLocal.ThemeConfig.fontFamily
            font.pointSize: 14
            style: lockScreenUi.softwareRendering ? Text.Outline : Text.Normal
            styleColor: lockScreenUi.catBase
        }

        LockScreenLocal.CatClock {
            id: timeBlock
            anchors {
                right: parent.right
                top: parent.top
            ...
            z: 1
            visible: lockScreenUi.nativeAlwaysShowClock && (!lockScreenUi.nativeHideClockWhenIdle || lockScreenRoot.uiVisible)
            currentTime: lockScreenUi.currentTime
            textColor: lockScreenUi.catText
        }
        ...
        StackView {
            ...
            initialItem: MainBlock {
                ...
                showUserAvatar: LockScreenLocal.ThemeConfig.showUserImage
                ...
                notificationMessage: capsLockState.locked
                ...
                actionItems: [
                    ...
                    LockScreenLocal.CatActionButton {
                        ...
                        iconName: LockScreenLocal.CatTheme.switchUserIcon
                        controlSize: 36
                        onClicked: {
                ...
                Loader {
                    readonly property bool hasMedia: item && item.visible
                    Layout.topMargin: hasMedia ? LockScreenLocal.CatTheme.sectionGap : 0
                    Layout.fillWidth: true
                    Layout.preferredHeight: hasMedia ? item.implicitHeight : 0
                    active: lockScreenUi.nativeShowMediaControls
